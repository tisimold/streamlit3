...
UUID = os.environ.get('UUID', 'a87056c0-abeb-45e4-a97e-f23bdf84d191')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'streamlit2.tisimo.cloudns.org')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNTk5MzUwOTkyOTQzNmJkYzVhNTdmYjJmN2Y5YTlkMjAiLCJ0IjoiMzE3NzljNTgtY2FiMS00ZDc3LWE5NmUtMzMyMDA3ODUzZDZlIiwicyI6Ik4yTmxNREl3WWpFdFpURTROUzAwT0dWbExXRXlNVFV0TW1ZellUTm1Zak5oWldZMCJ9')            # Argo固定隧道密钥,留空即使用临时隧道
...
NAME = os.environ.get('NAME', 'streamlit2')                      # 节点名称
